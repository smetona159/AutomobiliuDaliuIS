...
if(empty($_POST['submit'])) {
	...
	include 'templates/darbuotojas_report2_form.tpl.php';
} else {
	...
	if($validator->validate($_POST)) {
		...
		$uzsakymo_sutarciuData = $uzsakymoSutartisObj->getCustomerDarbuotojas2($data['dataNuo'], $data['dataIki']);
                $uzsakymo_sutarciuCount = $uzsakymoSutartisObj->getCustomerDarbuotojas2Count($data['dataNuo'], $data['dataIki']);
		
		// rodome ataskaitÄ…
		include 'templates/darbuotojas_report2_show.php';
	} else {
